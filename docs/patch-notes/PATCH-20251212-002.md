...
Architecture Decision Records (ADR) Integration - Establishes ADR-0001 through ADR-0006 as the canonical resolution engine, stat model, contest roles, skill/tag system, technique tag taxonomy, and effect resolution for the Unified SRD.
