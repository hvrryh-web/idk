...
Architecture Decision Records (ADR) Integration - Establishes ADR-0001 through ADR-0007 as the canonical resolution engine, stat model, contest roles, skill/tag system, technique tag taxonomy, effect resolution, and economy layer for the Unified SRD.
...
- Effect resolver pipeline needs ADR-0006 implementation
- Economy pipeline needs ADR-0007 implementation
