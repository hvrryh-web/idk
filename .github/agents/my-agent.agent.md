...
description: Agent 007 gets stuff done
---
...
Confirm file content — use the draft below as-is, or provide edits:

Purpose

Give Copilot a clear, consistent checklist and guidance when producing PR reviews so automated/suggested reviews are useful and actionable.
Scope
...
Call out obvious O(N^2) or heavy allocations in loops; request benchmarks if applicable.
Style & readability
